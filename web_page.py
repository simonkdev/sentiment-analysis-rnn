...
<body>
    <main>
        ...
        <footer>Built for learning: Flask API, NumPy model, IMDB sentiment labels. Source code: <a href="https://github.com/simonkdev/sentiment-analysis-rnn">GitHub</a></footer>
    </main>
